...
public class Assets {
	...
	public static String Images = Resources + File.separator + "theMachine" + File.separator + "images";
	public static String Fonts = Resources + File.separator + "theMachine" + File.separator + "fonts";
	public static String OpenCV = Resources + File.separator + "theMachine" + File.separator + "opencv";
	public static String Cascade = Resources + File.separator + "theMachine" + File.separator + "cascades"

...
public class App extends Assets {
	...
	private void detectAndDrawFace(Mat image) {
		...
		for (Rect rect : faceDetections.toArray()) {
			Imgproc.putText(image, CreateUser.User, new Point(rect.x + rect.width +10, rect.y + 100), 0, 1, new Scalar(60, 233, 238), 2);
			Imgproc.putText(image, CreateUser.Discription, new Point(rect.x + rect.width + 10, rect.y + 150), 0, 1, new Scalar(60, 233, 238), 2);
